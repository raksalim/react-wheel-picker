  ...
  return (
    <Sonner
      ...
      toastOptions={{
        classNames: {
          toast:
            "group rounded-2xl group-[.toaster]:bg-white group-[.toaster]:text-zinc-950 group-[.toaster]:border-zinc-200 group-[.toaster]:shadow-lg dark:group-[.toaster]:bg-zinc-800 dark:group-[.toaster]:text-zinc-50 dark:group-[.toaster]:border-zinc-700",
          description:
